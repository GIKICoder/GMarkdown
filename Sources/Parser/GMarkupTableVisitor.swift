...
public struct GMarkupTableVisitor: MarkupVisitor {
  ...
  init(style: Style) {
    self.style = style
    self.markTable = GMarkTable()
  }
  

  public typealias Result = GMarkTable
  
  mutating public func defaultVisit(_ markup: Markup) -> GMarkTable {
   ...
   */
  mutating public func visitTable(_ table: Table) -> GMarkTable{
  ...
  /**
   ...
   - returns: The result of the visit.
   */
  mutating public func visitTableHead(_ tableHead: Table.Head) -> GMarkTable {
  ...
  /**
   ...
   - returns: The result of the visit.
   */
  mutating public func visitTableBody(_ tableBody: Table.Body) -> GMarkTable{
  ...
  /**
   ...
   - returns: The result of the visit.
   */
  mutating public func visitTableRow(_ tableRow: Table.Row) -> GMarkTable{
