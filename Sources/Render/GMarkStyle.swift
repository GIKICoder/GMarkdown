...
struct DefaultFontStyle:FontStyle {
  var current: UIFont = .systemFont(ofSize: 15)
  var h1: UIFont = .systemFont(ofSize: 16, weight: .bold)
  var h2: UIFont = .systemFont(ofSize: 16, weight: .semibold)
  var h3: UIFont = .systemFont(ofSize: 15, weight: .bold)
  var h4: UIFont = .systemFont(ofSize: 15, weight: .semibold)
  var h5: UIFont = .systemFont(ofSize: 15, weight: .medium)
  var h6: UIFont = .systemFont(ofSize: 15, weight: .medium)
  var paragraph: UIFont = .systemFont(ofSize: 15)
  var inlineCodeFont: UIFont = .systemFont(ofSize: 15)
}
...
struct DefaultParagraphStyle: ParagraphStyle {
  ...
  var minimumLineHeight: CGFloat = 26
}

struct DefaultCodeBlockStyle: CodeBlockStyle {
  var customRender: Bool = false
  ...
  var padding: UIEdgeInsets = UIEdgeInsets(top: 12, left: 6, bottom: 12, right: 6)
}
...
struct DefaultBlockquoteStyle: BlockquoteStyle {
  var backgroundColor: UIColor = .gray.withAlphaComponent(0.35)
  var borderColor: UIColor = .gray
  var borderWidth: CGFloat = 2
  var font: UIFont = .italicSystemFont(ofSize: 16)
...
struct DefaultTableStyle: TableStyle {
  ...
  var padding: UIEdgeInsets = UIEdgeInsets(top: 12, left: 8, bottom: 12, right: 8)
  var cellWidth: CGFloat = 60
  var cellHeight: CGFloat = 44
  var headerBackgroundColor: UIColor = .lightGray
  var headerTextColor: UIColor = .black
  var rowAlternateBackgroundColor: UIColor? = .systemGray6
  var cellPadding: UIEdgeInsets = UIEdgeInsets(top: 6, left: 6, bottom:6, right:6)
  var cellMaximumWidth: CGFloat = UIScreen.main.bounds.width - 12 - 16
...
public struct MarkdownStyle: Style {
  ...
  public static func defaultStyle() -> MarkdownStyle {
    return MarkdownStyle(
      ...
      maxContainerWidth: UIScreen.main.bounds.width,
